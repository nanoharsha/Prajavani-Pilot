    ...
    <section id="journey" style={SS.section(C.white)}>
      <div style={SS.container}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(320px,1fr))', gap: 40, marginBottom: 48 }}>
          ...
          <div>
            <img src="images/Images/Complaint-resolved-in-PH.jpeg" alt="Citizen Satisfied at a Public Hearing, Tamsi, Adilabad"style={{ width:'100%', borderRadius:4, objectFit:'cover', aspectRatio:'4/3', display:'block' }} />
          </div>
        </div>
